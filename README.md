...
The course is divided into eight weeks, one week for each step in the path. Each week will explore one aspect of the path, with each lesson building on the previous one.
